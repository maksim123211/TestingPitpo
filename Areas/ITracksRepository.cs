...
namespace MauiApp1.Areas
{
    public record Track(string Name = "", bool IsFavorite = false)
    {
        ...
        public string Title { get; set; } = "Название отсутствует";
        ...
        public static Playlist CreatePlaylistFromFile()
        {
            ...
            var tracks = new Playlist
            {
                new Track
                {
                    Id = 1,
                    Title = "Anything Goes",
                    Description = "Updated Aug 31 • Emma Chamberlain",
                ...
                new Track
                {
                    ...
                    Description = "Updated Aug 18 • NPR Studios",
                ...
                new Track
                {
                    ...
                    Description = "Updated Aug 21• Stephanie Soo",
                ...
                new Track
                {
                    Id = 4,
                    Title = "Extra Dynamic",
                    Description = "Updated Aug 10 • ur mom ashley",
                ...
                new Track
                {
                    ...
                    Description = "Updated Aug 21• iHeart Studios",
